...
public class ExtendingTerminalBall extends SequentialCommandGroup {
  /** Creates a new ExtendingTerminalBall. */
  public ExtendingTerminalBall(Transport transport, SequentialCommandGroup drivingToGroup, SequentialCommandGroup drivingBackGroup) {
